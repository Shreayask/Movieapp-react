...
class Trendmovies extends Component{
    ...
    componentDidMount(){
        ...
        axios.get(`https://api.themoviedb.org/3/trending/movie/week?api_key=62c50a883d0b869ae32be8312cd25579&page=${page}`)
        .then((response)=>{
            ...
            <div class="pages">
                ...
                <div class="heading">
                       <div class="row" style={{width:"100%",paddingLeft:"1rem",backgroundColor:"#232e24"}}>
                           ...
                           <h2 class="titles" >Trending Movies </h2>
                           </div>
      ...
      <button class="page-link"  aria-label="Next "  onClick={(e)=>{this.handlechange(e)}}>
        <span aria-hidden="true">&raquo;</span>
                    ...
                    <div class=" col-lg-3 col-sm-12 col-md-6 d-flex ">
                        <Link to = {`/display?id=${c.id}&media=${c.media_type}&poster=${c.poster_path}&date=${c.release_date}&title=${c.title}&overview=${c.overview}&vote=${c.vote_average}`}>
